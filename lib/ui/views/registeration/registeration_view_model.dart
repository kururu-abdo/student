...
class RegistertionFormBloc extends FormBloc<String, String> {
  ...
  final idNumberField = TextFieldBloc(validators: [FieldBlocValidators.required]);
 final firstNameField = TextFieldBloc(validators: [FieldBlocValidators.required]);
 final lastNameField = TextFieldBloc(validators: [FieldBlocValidators.required]);
 ...
 RegistertionFormBloc() {
    addFieldBlocs(
      step: 0,
      fieldBlocs: [emailField, passwordField ,idNumberField ,firstNameField ,lastNameField],
    );
    addFieldBlocs(
      step: 1,
  ...
  @override
  List<FieldBloc> get fieldBlocs => [emailField, passwordField ,idNumberField ,firstNameField ,lastNameField];
