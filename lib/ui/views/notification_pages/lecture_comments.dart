...
import 'package:student_side/model/lecture.dart';
...
class _LectureCommentsState extends State<LectureComments> {
  ...
  Widget build(BuildContext context) {
    ...
    var teacherProvider = Provider.of<UserProvider>(context);
        ...
        children: [
          ...
          Card(
            ...
            child: Container(
                height: 80,
                child:
                    Center(child: Text(lecture != null ? lecture.name : ""))),
          ),
          SizedBox(
            height: 10,
          ),
                        ...
                        children: [
                          ListTile(
                            ...
                            subtitle: Text(snapshot.data.docs[index]
                                .get('commentator')['role']),
                          ),
                          ShowMoreText(
                            snapshot.data.docs[index].get('comment_text'),
                            maxLength: 100,
                  ...
                  onPressed: () async {
                    ...
                    await comments.add({
                      ...
                      'commentator': <dynamic, dynamic>{
                        'id': teacherProvider.getUser().id_number,
                      ...
                      body: jsonEncode(
                        <String, dynamic>{
                          ...
                          'data': <String, dynamic>{
                            ...
                            'status': 'done',
                            'screen': 'consults',
                            'data': {"id": lecture.id, "type": 'comment'}
                          },
...
class UserDetailsWithFollow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var userBloc = Provider.of<UserProvider>(context);
    var me =
        Commentator(userBloc.getUser().id_number, userBloc.getUser().name, 'طالب');
